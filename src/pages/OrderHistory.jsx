...
import { getOrderBySeller } from "../../utils/orderApiFetch";
        ...
        <div className="overflow-scroll-x max-sm:mt-20 md:pt-4 pt-2">
          <div className="w-10/12 mx-auto max-sm:w-fit md:w-11/12  lg:w-11/12  bg-color-light rounded shadow-md  shadow-black pb-4 mb-10">
            ...
            {Object.values(orderSellerData).map((orders, index) => (
              <div
                key={index}
                className="bg-color-accent1 p-2 border-2 border-color-secondary"
              >
                <div className="flex">
                  <p>{orders.id}</p>
                  <div>
                    {orders.items.map((item, index) => (
                      <div key={index} className="flex-wrap">
                        <div className="flex w-full gap-8 mb-10 max-sm:text-sm md:text-normal lg:text-normal md:gap-6 lg:gap-14">
                          <div className="h-32 border-2 border-solid border-color-secondary ml-10 md:w-16 md:h-20 md:ml-6 lg:w-48 lg:h-24 lg:ml-20 max-lg:w-20 ">
                            <img
                    ...
                    <div className="ml-10 md:ml-6 lg:w-48 lg:ml-20 text-color-secondary ">
