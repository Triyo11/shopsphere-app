            ...
            <div className=' max-w-max flex gap-8 mb-10 max-sm:text-sm md:text-normal lg:text-normal md:gap-6 lg:gap-14'>
              ...
              <div className='  pl-4 mt-4 md:w-11/12  md:mt-0 lg:w-full '>
                <div className='flex gap-24 mb-8 md:gap-9 md:mb-3 lg:gap-20'>
                  ...
                  <button type='submit' className='ml-8 md:ml-2 lg:ml-8 bg-color-accent1 text-color-secondary border-2 border-solid border-color-secondary rounded px-4 py-1 cursor-default lg:mr-10'>
                    Unpaid
                  </button>
                  ...
                  <div className='  text-color-secondary  mt-3'>
                      ...
                      <form action="" className='py-1 flex gap-4'>
                          ...
                          <input type="text" className='h-10 w-56 md:h-8 md:w-48 lg:h-10 lg:w-56 rounded border-2 border-solid block px-2   outline-none '  placeholder='input no.resi' />
                                
                          <button type='submit' className='bg-color-primary text-normal text-color-light lg:px-8 Lg:py-1 ml-2 md:py-0 md:px-5 max-sm:py-0 max-sm:px-5 cursor-pointer hover:bg-color-secondary shadow-md  shadow-color-secondary '>
                            Send
                          </button>
