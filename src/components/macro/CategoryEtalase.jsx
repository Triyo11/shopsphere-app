...
const CategoryEtalase = ({ categoryName }) => {
  return (
    <div className="font-poppins mt-24 bg-color-secondary max-h-max px-10 py-10 rounded-3xl">
      <div className="flex justify-between w-full px-7">
        <h2 className="font-bold text-2xl text-color-primary">{categoryName}</h2>
        <NavLink to={"/"} className="font-bold text-xl text-color-light">See more ...</NavLink>
      </div>
